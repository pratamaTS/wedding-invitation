<template>
  <section class="w-full bg-cream">
    <section class="container-section pb-12">
      <HeaderSection text-color="text-black" subtitle="Dengan tidak mengurangi rasa hormat, kami mengajak para tamu undangan agar bisa berhadir pada serangkaian acara kami" title="Runtutan Acara"></HeaderSection>
      <Card>
        <template v-slot:body>
          <div class="px-6 py-8 text-center text-sm font-medium" v-for="(timeline, index) in timelines" :key="index">
            <section data-aos="fade-up">
              ...
              <a class="btn bg-gray-800 text-amber-500" :href="timeline.mapUrl" target="_blank">
        ...
        <template v-slot:footer>
          <section class="">
            ...
            <div class="px-6 pt-5 pb-8 text-center">
              <p class="text-sm text-black">Konfirmasi kehadiran anda pada buku tamu</p>
              <button @click="goToGuestBook" class="btn bg-gray-800 text-amber-500">
